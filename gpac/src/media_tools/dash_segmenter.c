...
struct __gf_dash_segmenter
{
	...
	char *seg_rad_name;
	const char *seg_ext;
	char *id3_source;/*DASH_IMPLEMENTATION_NIELSEN*/
...
//	u32 first_seg;
	...
	/*DASH_IMPLEMENTATION_NIELSEN*/
	id3_source = dash_cfg->id3_source;
	/*DASH_IMPLEMENTATION_NIELSEN*/
...
/*DASH_IMPLEMENTATION_NIELSEN*/
GF_EXPORT
GF_Err gf_dasher_enable_id3_source(GF_DASHSegmenter *dasher, const char *id3_source)
{
	if (!dasher) return GF_BAD_PARAM;
	if (id3_source) dasher->id3_source = gf_strdup(id3_source);
	return GF_OK;
}
/*DASH_IMPLEMENTATION_NIELSEN*/
