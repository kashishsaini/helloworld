...
enum
{
	...
	GF_ISOM_BOX_TYPE_EMSG   = GF_4CC( 'e', 'm', 's', 'g' ),/*DASH_IMPLEMENTATION_NIELSEN*/
...
typedef struct __emsg_box
{
        ...
        char *value;
        u32  timescale;
        u32  presentation_time_delta;
        u32  event_duration;
        u32  id;
        u32  id3_count;/*This field not in ISO document*/
        u8   *message_data;
}GF_DASHEventMessageBox;
/*DASH_IMPLEMENTATION_NIELSEN*/
